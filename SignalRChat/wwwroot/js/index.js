class ObChat {
    ...
    static init() {
        ...
        this.chat = new signalR.HubConnectionBuilder().withUrl("/chatHub").build();
        //image 関連
        this.imageData = '';
        return this;
    }
    ...
    */
    static setHandlers() {
        //メッセージ受信時のイベントハンドラー
        this.chat.on("ReceiveMessage", function (user, message) {
    ...
    static post(jsonString) {
        try {
            ...
            ObChat.chat.invoke("SendMessage", ObChat.accInfo.name, jsonString).catch(function (err) {
